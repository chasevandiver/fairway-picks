  ...
  return (
    <div>
      ...
      {PLAYERS.map((player) => {
        ...
        const grandTotalStrokes = (roundTotals as (number | null)[]).reduce((sum: number, v: number | null) => sum + (v ?? 0), 0)
        const playedRounds = roundTotals.filter((v: number | null) => v !== null).length
